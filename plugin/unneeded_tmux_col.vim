...
if expand('%:p') ==# expand('<sfile>:p')
  unlet! g:loaded_dubs_appearance_unneeded_tmux_col
endif

if exists('g:loaded_dubs_appearance_unneeded_tmux_col') || &cp

  finish
endif

let g:loaded_dubs_appearance_unneeded_tmux_col = 1

...
if expand('%:p') ==# expand('<sfile>:p')
  unlet! g:loaded_dubs_appearance_old_mswin_options
endif

if exists('g:loaded_dubs_appearance_old_mswin_options') || &cp

  finish
endif

let g:loaded_dubs_appearance_old_mswin_options = 1

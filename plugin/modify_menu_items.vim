...
if expand('%:p') ==# expand('<sfile>:p')
  unlet! g:loaded_dubs_appearance_modify_menu_items
endif

if exists('g:loaded_dubs_appearance_modify_menu_items') || &cp

  finish
endif

let g:loaded_dubs_appearance_modify_menu_items = 1

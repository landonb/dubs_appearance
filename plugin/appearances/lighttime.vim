...
"
" Then copy the output and paste it after this comment,
...
"
" Then fix all the "links to":
"
"   :.,$s/^:highlight \([a-zA-Z]\+\) links to \([a-zA-Z]\+\)$/:highlight link \1 \2/gc
"
" Finally, fix the "cleared":
"
"   :.,$s/^:highlight \([a-zA-Z]\+\) cleared$/:highlight clear \1/gc
...
:highlight Normal ctermfg=0 ctermbg=15 guifg=Black guibg=White font=Hack Regular 9
...
:highlight vimSubst1 links to vimSubst
